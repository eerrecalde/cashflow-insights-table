...
export function CashflowNodeRow({
  ...
  return (
    <tr className={`group border-b transition-colors ${tone}`}>
      <th
        scope="row"
        className={`sticky left-0 z-10 min-w-64 border-r border-inherit bg-inherit py-2.5 pr-4 text-left transition-colors group-focus-within:bg-sky-50 group-hover:bg-sky-50 ${
          isSection
