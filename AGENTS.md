...
## Challenge task reference

For this technical challenge, `PLAN.md` is the canonical task list. When a request refers to a task number, use the **Work packages** IDs in that file:

1. Typed mock API
2. Data access
3. Static table shell
4. Tree interaction
5. Scale
6. Finish and verify
